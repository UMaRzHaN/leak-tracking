...
| Задача            | Что делает                                                                                                                                                                                                                                        |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `quality`         | Чистота дерева → lint → format → три проверки типов (`typecheck`, `:strict`, `:tools`) → аудит зависимостей → бюджет поддерживаемости → тесты с покрытием → ratchet → сборка → бюджет бандла → лицензии → SBOM → манифест верификации и чек-суммы |
