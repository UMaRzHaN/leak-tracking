export const addLeak = {
  ...
  noCoords: {
    title: "Сохранить без координат?",
    gpsOff:
      "GPS выключен, поэтому координаты не будут записаны. Утечку можно будет найти в базе, но на карте она не появится.",
    noFix:
      "Координаты ещё не определены, поэтому они не будут записаны. Утечку можно будет найти в базе, но на карте она не появится.",
    confirmLabel: "Сохранить без координат",
