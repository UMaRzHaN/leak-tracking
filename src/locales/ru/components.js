export const components = {
   ...
   */
  fields: {
    // Единственное исключение: у утечки район — тот, «в котором зафиксирована
    // утечка», а карточка описывает не событие, а железо. Остальные подсказки
    // локации берутся из `addLeak.fields` как есть — см. localizeComponentSteps.
    district: {
      hint: "Административный район города, в котором стоит компонент",
    },
    subdivision: {
