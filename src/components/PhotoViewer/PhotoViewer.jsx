  ...
  return (
    <div className={s.overlay} onClick={onClose} role="dialog" aria-modal="true">
      ...
      {canPrev && (
        ...
        >
          <svg width="11" height="20" viewBox="0 0 11 20" fill="none" aria-hidden="true">
            <path d="M9.5 1.5L1.5 10L9.5 18.5" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
      )}
      ...
      {canNext && (
        ...
        >
          <svg width="11" height="20" viewBox="0 0 11 20" fill="none" aria-hidden="true">
            <path d="M1.5 1.5L9.5 10L1.5 18.5" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
      )}

      <div className={s.imgWrap} onClick={(e) => e.stopPropagation()}>
        <img
          key={idx}
          src={currentSrc}
