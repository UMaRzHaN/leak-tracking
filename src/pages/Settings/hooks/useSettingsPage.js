...
export function useSettingsPage({
   ...
   * Это вопрос про устройство приложения, а ответ на него целиком лежит
   * внутри файла: и .xlsx, и оба архива — зипы с узнаваемыми именами внутри.
   *
   * Тип определяется по содержимому, дальше работают те же обработчики, что и
   * были: маршрут новый, разбор старый.
   */
